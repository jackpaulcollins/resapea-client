    ...
    if (recipe.photo_url || selectedImage) {
      return (
        <div className="flex flex-row p-5 justify-center items-center">
          <img
            className="h-30 w-96 rounded"
            src={`${recipe.photo_url ? recipe.photo_url : selectedImage}`}
          ></img>
          <span
            className="text-red-600"
            onClick={(e) => {
              recipe.photo_url
                ? handleRecipePhotoDelete(e)
      ...
      <div className="w-1/2 rounded-lg shadow-lg bg-white p-5">
        <form onSubmit={(e) => handleSubmit(e)}>
          <div>
              ...
              <div className="flex flex-row w-1/2 items-center">
                ...
                <div className="w-2/3 ml-2">
                  <DropDown
                    ...
                    defaultValue={
                      recipeGenre === undefined ? recipe.genre : recipeGenre
                    }
            ...
            <div className="mt-10">
              ...
              <DropDown
                ...
                defaultValue={
                  recipeCompatibilities === undefined
                    ? recipe.compatibilities
                    : recipeCompatibilities
                }
          ...
          <div>
            <div className="p-5">
              <p>Ingredients</p>
              <IngredientsDetailsEditList
                ingredients={ingredients}
                addElementToRecipeIngredientsOrInstructionsArray={
                  addElementToRecipeIngredientsOrInstructionsArray
                }
              ...
              <div className="mt-3 mb-3">
                <button
                  ...
                  onClick={(e) =>
                    addElementToRecipeIngredientsOrInstructionsArray(e, "ing")
                  }
                >
                  <PlusIcon />
                </button>
          ...
          <div>
            <div className="p-5">
              ...
              <div className="mt-3 mb-3">
                <button
                  className="text-blue-400"
                  onClick={(e) =>
                    addElementToRecipeIngredientsOrInstructionsArray(e, "ins")
                  }
                >
                  <PlusIcon />
                </button>
            ...
            <div>{removeOrUpdatePictutre()}</div>
          </div>
