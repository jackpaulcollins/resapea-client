  ...
  return (
    <div>
      ...
      <Routes>
        <Route
          path={"/"}
          element={<Dashboard loggedIn={loggedIn} currentUserId={user.id} />}
        />
        <Route
          path={"/recipe/:id"}
          element={<RecipeView loggedIn={loggedIn} currentUser={user} />}
        />
        <Route
          path={"/create-recipe"}
          element={<RecipeCreate loggedIn={loggedIn} currentUser={user} />}
        />
        <Route
          path={"/recipe/:id/edit"}
          element={<RecipeEdit loggedIn={loggedIn} currentUser={user} />}
        />
        <Route
          path={"/login"}
        ...
        <Route
          path={"/register"}
          element={
            <Registration loggedIn={loggedIn} handleLogin={handleLogin} />
          }
        />
        <Route path={"/forgot_password"} element={<RequestForgotPassword />} />
        <Route path={"/password_reset/:token"} element={<ResetPassword />} />
        <Route path={"/search-results"} element={<SearchResults />} />
        <Route
          path={"/user/:id"}
          element={<UserPanel currentUser={user} refreshUser={isLoggedIn} />}
        />
      </Routes>
    </div>
  );
