      ...
      <div className="flex flex-wrap bg-gray-100 pb-2 border-solid border-gray-200 border-t">
        ...
        <div className="w-full px-4 mt-4">
          <textarea
            ...
            className="bg-gray-50 rounded border border-gray-400 leading-normal resize-none w-full h-20 py-2 px-3 font-medium placeholder-gray-700 focus:outline-none focus:bg-white"
            name="body"
            required
          ></textarea>
        </div>
